...
// function EventDetails({ event, editEventOpen, setEditEventOpen, ...props }) {
...
//   return (
//     <Dialog open={editEventClose} onCLose={handleEditEventClose}>
...
//   return {
//     putEvent: (body) => dispatch(putEvent(body)),
//   };
// }
